...
3. 全局替换`Q1351998764`为仓库所有者ID; 全局替换`nonebot-plugin-wenan`为插件名; 全局替换`nonebot-plugin-wenan`为包名; 修改 python 徽标中的版本为你插件的运行所需版本
...
<summary>pdm</summary>
    ...
    pdm add nonebot-plugin-wenan
</details>
<details>
<summary>poetry</summary>

    poetry add nonebot-plugin-wenan
</details>
<details>
<summary>conda</summary>

    conda install nonebot-plugin-wenan
</details>
